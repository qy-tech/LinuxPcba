    ...
    def _init_config(self):
        ...
        if not os.path.exists(self.config_file_path):
            self.config[const.TEST_CASE_PATH] = {
                ...
                const.RELAY54: '54',
                const.RELAY55: '55',
                const.LED_R: 'echo r > /sys/class/leds/aw2026/color; sleep 1; echo off > /sys/class/leds/aw2026/color',
                const.LED_G: 'echo g > /sys/class/leds/aw2026/color; sleep 1; echo off > /sys/class/leds/aw2026/color',
                const.LED_B: 'echo b > /sys/class/leds/aw2026/color; sleep 1; echo off > /sys/class/leds/aw2026/color',
